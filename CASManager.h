...
namespace tpc {
    ...
    namespace cas {
        ...
        public:
            /*!
             * add an article in pdf or xml format to the Textpresso repository, transforming it in cas format
             ...
             */
            static void add_file(FileType type, const std::string &cas_repo_location, const std::string &literature,
