...
wget http://apache.osuosl.org/activemq/activemq-cpp/3.9.5/activemq-cpp-library-3.9.5-src.tar.bz2 -O \
...
update -q; apt-get install -q -y oracle-java11-installer
...
--with-jdk="/usr/lib/jvm/java-11-oracle/include -I/usr/lib/jvm/java-11-oracle/include/linux" --enable-static \
